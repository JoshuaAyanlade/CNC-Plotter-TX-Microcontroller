...
void msendGcode() {
  joyStick();
  //Serial.println("counter: " + String(counterX));
  //Serial1.println("F0");  //false positive
  while (rxStateP) {
    String l_line = "";
    l_line ="F0";
    Serial1.println(l_line);  //false positive
    Serial.println(l_line);
    ...
    if (okToSendGcode == true) {
      lcd.clear();
      l_line = "";
      //l_line = "G91 X" + String(counterX) + " Y0 F4000";
  ...
  while (ryStateP) {
    ...
    if (okToSendGcode == true) {
      lcd.clear();
      l_line = "";
      //l_line = "G91 X0 Y" + String(counterY) + " F4000";
